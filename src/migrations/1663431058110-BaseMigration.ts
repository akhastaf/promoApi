...
export class BaseMigration1663431058110 implements MigrationInterface {
    name = 'BaseMigration1663431058110'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_managers_user" ADD CONSTRAINT "FK_b5e689010d22c66273c4b8be09f" FOREIGN KEY ("userId_1") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_managers_user" ADD CONSTRAINT "FK_bbe004b9ee2b70afdaf6794577f" FOREIGN KEY ("userId_2") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
