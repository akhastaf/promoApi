...
export class BaseMigration1666549642380 implements MigrationInterface {
    name = 'BaseMigration1666549642380'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "avatar" character varying NOT NULL DEFAULT 'public/default.png', "language" "public"."user_language_enum" NOT NULL DEFAULT 'en', "role" "public"."user_role_enum" NOT NULL, "phone" character varying, "address" character varying, "token" character varying, "isActive" boolean NOT NULL DEFAULT false, "count" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "salesmanId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
